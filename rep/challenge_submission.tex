...
\begin{table}[h]
    ...
    \begin{tabular}{l | p{0.5\linewidth} | c}
        \textbf{Section} & \textbf{Description} & \textbf{Overall Weight}\\ 
        \hline \hline 
        Proposal Quality & Quality of proposal: clear, concise writing;  thoughtful and complete explanations of how the proposed toilet design concept meets the specifications listed; accompanying CAD file (or other file format) is clear and complete. & /10
    \end{tabular}}
\end{table}